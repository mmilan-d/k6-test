    ...
    sessionId = cookies['AUTH_SESSION_ID'][0]
      ...
      response = http.post(
        ...
        },
        {
          headers: {
            ...
            cookie:
              `AUTH_SESSION_ID=${sessionId}; AUTH_SESSION_ID_LEGACY=${sessionId}; KC_RESTART=eyJhbGciOiJIUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICIyM2E5MTNmNC05OTdmLTQ1YjMtYjhlYi0zZmJjMGExMTJjZmQifQ..BOR9mkK8l_fkBAZnVG_TlAw--otahlFbMRunLM1YNg0`,
            origin: 'null',
            pragma: 'no-cache',
      ...
      response = http.get('https://admin.mvtest.qdak.hu/favicon.ico', {
        headers: {
          ...
          'cache-control': 'no-cache',
          pragma: 'no-cache',
          referer: 'https://admin.mvtest.qdak.hu/shops/676/administration/templates',
          'sec-ch-ua': '"Not.A/Brand";v="8", "Chromium";v="114", "Google Chrome";v="114"',
          'sec-ch-ua-mobile': '?1',
          'sec-ch-ua-platform': '"Android"',
          'sec-fetch-dest': 'image',
